...
#@registry.register_transform(display_name="Domain DNS Infrastructure", input_entity=["maltego.NSRecord", "maltego.DNSName"],
...
class DomainDNSHistoryNS_FOR(DiscoverableTransform):
